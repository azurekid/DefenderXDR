@{
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @('Defender', 'XDR', 'Security', 'Microsoft365', 'GraphAPI', 'SecurityCenter', 'ThreatProtection')

            # A URL to the license for this module.
            LicenseUri = 'https://github.com/azurekid/DefenderXDR/blob/main/LICENSE'
            ...
            ReleaseNotes = 'Initial release of DefenderXDR PowerShell module for managing Microsoft Defender XDR through Graph API'
