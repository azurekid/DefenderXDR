...
class DefenderAlert : DefenderEntity {
    ...
    # Full constructor with common properties
    DefenderAlert([string]$alertId, [string]$title, [string]$severity) : base($alertId) {
        $this.AlertId = $alertId
        $this.Id = $alertId
...
class DefenderIncident : DefenderEntity {
    ...
    # Full constructor with common properties
    DefenderIncident([string]$incidentId, [string]$title, [string]$severity) : base($incidentId) {
        $this.IncidentId = $incidentId
        $this.Id = $incidentId
        $this.DisplayName = $title
        $this.Severity = $severity
...
class DefenderIndicator : DefenderEntity {
    ...
    # Full constructor with action and severity
    DefenderIndicator([string]$indicatorValue, [string]$indicatorType, [string]$action, [string]$severity) : base() {
        $this.IndicatorValue = $indicatorValue
        $this.IndicatorType = $indicatorType
        $this.Action = $action
        $this.Severity = $severity
